  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="数据状态" prop="shujuzhuangtai">
		  <el-select  @change="shujuzhuangtaiChange" clearable v-model="searchForm.shujuzhuangtai" placeholder="请选择数据状态">
		    <el-option
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.shujuzhuangtai!='' && this.searchForm.shujuzhuangtai!=undefined){
            params['shujuzhuangtai'] = this.searchForm.shujuzhuangtai
          }
      this.$http({
